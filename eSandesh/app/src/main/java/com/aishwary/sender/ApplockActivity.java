			...
			public void onClick(View _view) {
				if (applock_active) {
					if (edittext2.getText().toString().equals("")) {
						SketchwareUtil.showMessage(getApplicationContext(), "Password required");
					}
					else {
						...
						SketchwareUtil.showMessage(getApplicationContext(), "App lock successfully activated");
					}
				}
				else {
					...
					SketchwareUtil.showMessage(getApplicationContext(), "App lock successfully deactivated");
				}
			}
		});
	}
