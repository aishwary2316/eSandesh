...
public class MainActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				i.setData(Uri.parse("mailto:".concat("aishwary2316@outlook.com")));
				i.putExtra("subject", "Contacting developer of Sender app");
				i.putExtra("body", "Type your complaint or recommendation here");
				startActivity(i);
			}
		});
	...
	private void _colours_round_splash () {
