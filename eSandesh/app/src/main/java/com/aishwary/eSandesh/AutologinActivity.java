...
public class AutologinActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_fauth_sign_in_listener = new OnCompleteListener<AuthResult>() {
			...
			public void onComplete(Task<AuthResult> _param1) {
				...
				final String _errorMessage = _param1.getException() != null ? _param1.getException().getMessage() : "";
				if (_success) {
					textview1.setText("Signin complete");
					in.setClass(getApplicationContext(), MenuActivity.class);
					startActivity(in);
					_customText("Auto sign in successfully completed");
				}
				else {
					_customText("Auto sign in failed");
					d.setTitle("Auto Sign in failed");
					d.setMessage("Auto sign in failed\nError message : ".concat(_errorMessage));
	...
	private void initializeLogic() {
		...
		if ((FirebaseAuth.getInstance().getCurrentUser() != null)) {
			...
			if (!login.getString("autologin", "").equals("") && login.getString("autologin", "").equals("allowed")) {
				fauth.signInWithEmailAndPassword(login.getString("email", ""), login.getString("password", "")).addOnCompleteListener(AutologinActivity.this, _fauth_sign_in_listener);
	...
	private void _TheGlowingLoader () {
		...
		configuration.setLine1Color(0xFF3F51B5);
		configuration.setLine2Color(0xFFFF5C5C);
		configuration.setRippleColor(0xFF3F51B5);
		configuration.setParticle1Color(0xff3F51B5);
		configuration.setParticle2Color(0xFF3F51B5);
