...
public class RegisteredActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		...
		dialog.setMessage("As you have created a new sender account just now you are advised to visit Edit Profile page accessible through Menu page to change and give your account a nickname.\nAs any one creates an account they are automatically given a default nickname which should be changed immediately so that other users may recognize you. ");
